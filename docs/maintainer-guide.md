...
Everything here is for people who run discovery campaigns, verify sources, and operate crawls. Job seekers only need the [README](../README.md) and the [quickstart](job-seeker-quickstart.md).
